...
public class FileEncryptTest {
  ...
  public static void main(String[] args) {
    ...
    String outFileName = "/Users/aca/Downloads/pkg1_enc.csv.gz";
    String recoverFile = "/Users/aca/Downloads/pkg1_enc.csv.out";
    // String fileName = "/Users/akhilesh.trivedi/searchid_728.csv";
    // String fileName = "tile_doc.in";
    // amanEncrypt(fileName, outFileName);
    amanDencrypt(outFileName, recoverFile);
  }

  private static void amanEncrypt(String fileName, String outFileName) {
  ...
  public static InputStream encryptFile(
      String fileName,
      PGPPublicKey encKey,
      char[] passPhrase,
      boolean armor,
  ...
  public static PGPPublicKey readPublicKeyFromCol(InputStream in) throws Exception {
    PGPPublicKeyRing pkRing = null;

    // PGPPublicKeyRingCollection pkCol = new PGPPublicKeyRingCollection(in,
    // FP_CALC);
    PGPPublicKeyRingCollection pkCol =
        new PGPPublicKeyRingCollection(PGPUtil.getDecoderStream(in), FP_CALC);
    ...
    while (it.hasNext()) {
      ...
      while (pkIt.hasNext()) {
        ...
        System.out.println(
            "Encryption key = " + key.isEncryptionKey() + ", Master key = " + key.isMasterKey());
  ...
  public static void decryptFile(
      InputStream outFileIn, InputStream privKeyStream, char[] passPhrase, String outFileName) {
    // ----- Decrypt the file
    ...
    try {
      ...
      while (outFileIn.read(read, 0, 10240) != -1) {
  ...
  private static PGPPrivateKey findSecretKey(InputStream keyIn, long keyID, char[] pass)
    ...
    PGPSecretKeyRingCollection pgpSec =
        new PGPSecretKeyRingCollection(PGPUtil.getDecoderStream(keyIn), FP_CALC);
  ...
  private static void decryptIt(InputStream in, InputStream keyIn, char[] passwd, String filename)
      throws Exception {
  ...
  private static void signFile(
      String fileName, InputStream keyIn, OutputStream out, char[] pass, boolean armor)
